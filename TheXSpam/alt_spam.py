...
async def pspam(client: Client, message: Message):
    cid = message.chat.id
    if int(cid) in GROUP:
        await message.reply_text("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ ʀᴀᴅʜᴀ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ ʙᴀʙy.")
        return
...
async def hang(xspam: Client, message: Message): 
    ...
    if int(message.chat.id) in GROUP:
        await message.reply_text("__sᴏʀʀʏ ɪ ᴄᴀɴ'ᴛ ʜᴀɴɢ ʜᴇʀᴇ ʙᴀʙy__")
        return
